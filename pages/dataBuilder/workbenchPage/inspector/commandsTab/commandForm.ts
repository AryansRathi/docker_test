...
export class CommandForm {
    ...
    readonly conditionTechnicalNameInput: Locator;
    ...
    constructor(parent: CommandsTab) {
        ...
        this.conditionValueInput = this.filteringSection
            ...
            .first();
        this.conditionTechnicalNameInput = this.filteringSection
            .locator(
                '[data-testid^="DB-CmdBasicCondition-TechnicalNameInput-"][data-testid$="-IxInput-root"] input'
            )
            .first();
    }
    ...
    public async addCondition(condition: CommandCondition) {
        ...
        await this.conditionTechnicalNameInput.fill(condition.technicalName);
    }
}
