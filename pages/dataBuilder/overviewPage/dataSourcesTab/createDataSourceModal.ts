...
export class CreateDataSourceModal {
    ...
    constructor(parent: DataSourcesTab) {
        ...
        this.postgreSQLSourceItem = this.root.locator(
            '[data-test-id="DB-TypePage-SourceItem-PostgreSQL"]'
        );
        this.sqlServerSourceItem = this.root.locator(
            '[data-test-id="DB-TypePage-SourceItem-SQLServer"]'
        );
        ...
        this.credentialTestButton = this.root.getByTestId(/DB-(Pg|MsSql)Page-Test-IxButton-root/);
        this.credentialApplyButton = this.root.getByTestId(/DB-(Pg|MsSql)Page-Apply-IxButton-root/);
        ...
        this.nextButton = this.root.getByTestId('DB-CommonPage-Next-IxButton-root');
    }
